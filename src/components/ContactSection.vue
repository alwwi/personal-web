...
<template>
    <section class="text-white mt-20" id="contact">
        <h2 class="text-4xl font-bold text-white text-left mb-4 xl:pl-16">Let's Connect</h2>
        <div class="grid md:grid-cols-2 gap-4 relative px-4 xl:px-16 mt-8" data-aos="zoom-in-up">
            <div>
                <div class="col-lg-4 col-mf-4 mb-lg-0mt-5">
            ...
            <!-- <div
                style="background: #111a3e; width: 100%x; height: 100%; border-radius: 20px; 
                overflow: hidden; border: 1px solid #111a3e; backdrop-filter: blur(9px); -webkit-backdrop-filter: blur(9px);">
                <form class="flex flex-col p-2" data-aos="zoom-in-up">
                    ...
                    <button
                        class="z-1 w-[100%!important] px-6 md:px-7 py-3 rounded-full sm:w-max justify-center text-white bg-primary border-2 border-transparent">
                        Send Message
                    </button>
                </form>
            </div> -->
            <div class="bg-gradient-to-tr opacity-25 from-[#570cac] to-primary blur-2xl h-20 w-20 z-0 absolute -top-1/2 -left-4 transform -translate-x-2/3
            -translate-1/2
            "></div>
        </div>
    </section>
