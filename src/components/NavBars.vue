...
<template>
    <header class="flex justify-between items-center p-6 bg-opacity-50 z-20">
        <div class="text-white text-3xl font-bold">Welcome to my personal website</div>
        ...
        <div class="md:hidden z-30">
            ...
            >
                <span v-if="isMenuOpen" class="text-5xl">
                    <img src="https://img.icons8.com/ios-filled/100/fffff/delete-sign.png" alt="close" width="50"
                        height="50" />
                </span>
